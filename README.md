...
```sh
curl -L -o /tmp/missive-1.0.2-x86_64.flatpak https://github.com/benjaminbellamy/missive/releases/download/v1.0.2/missive-1.0.2-x86_64.flatpak && flatpak install --user /tmp/missive-1.0.2-x86_64.flatpak
```
